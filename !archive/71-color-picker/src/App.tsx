...
const App = () => {
  ...
  const handleColorChange = (updatedColor: RGBColor) => {
    setColor({
      ...
      g: updatedColor.g,
      b: updatedColor.b,
      a: updatedColor.a !== undefined ? updatedColor.a : 1 // Встановлюємо a на 1, якщо воно undefined
    })
  }
  ...
  return (
    <div>
      <h1 style={{ color: `rgba(${color.r}, ${color.g}, ${color.b}, ${color.a})` }}>
      ...
      {showColorPicker && (
        <div
          ...
          draggable={false}
        >
          <SketchPicker color={color} onChange={(colorResult) => handleColorChange(colorResult.rgb)} />
        </div>
      )}
    </div>
  )

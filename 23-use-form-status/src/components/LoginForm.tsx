...
import SubmitButton from './SubbmitButton'
  ...
  return (
    <form action={submitAction}>
      <div className="form-group">
        <input id="username" type="text" placeholder="Username" autoComplete="username" name="username" />
        <label htmlFor="username">Username</label>
      </div>

      <div className="form-group">
        <input id="password" type="password" placeholder="Password" autoComplete="new-password" name="password" />
